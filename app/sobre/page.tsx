export default function About() {
    return (
        <>
            <section className='h-full w-full bg-slate-800 flex flex-col space-y-4 pt-4 justify-center items-center'>
                <div className='text-slate-100 text-5xl hero'>
                    Sobre
                </div>
                <article className='flex flex-col items-center justify-center px-10 py-4'>
